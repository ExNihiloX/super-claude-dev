...
# Linear state name mapping (customize if your team uses different names)
LINEAR_STATE_BACKLOG="${LINEAR_STATE_BACKLOG:-Backlog}"
LINEAR_STATE_TODO="${LINEAR_STATE_TODO:-Todo}"
LINEAR_STATE_IN_PROGRESS="${LINEAR_STATE_IN_PROGRESS:-In Progress}"
LINEAR_STATE_BLOCKED="${LINEAR_STATE_BLOCKED:-Blocked}"
LINEAR_STATE_IN_REVIEW="${LINEAR_STATE_IN_REVIEW:-In Review}"
LINEAR_STATE_DONE="${LINEAR_STATE_DONE:-Done}"

# Use Linear as primary communication (set to 1 to enable)
USE_LINEAR="${USE_LINEAR:-1}"
...
export SLACK_WEBHOOK_URL SLACK_CHANNEL DEFAULT_BRANCH FEATURE_BRANCH_PREFIX
export LINEAR_API_KEY LINEAR_TEAM_ID LINEAR_PROJECT_ID USE_LINEAR
export LINEAR_STATE_BACKLOG LINEAR_STATE_TODO LINEAR_STATE_IN_PROGRESS
export LINEAR_STATE_BLOCKED LINEAR_STATE_IN_REVIEW LINEAR_STATE_DONE
